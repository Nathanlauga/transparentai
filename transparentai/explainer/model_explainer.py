...
class ModelExplainer():
        ...
        if feature_classes is not None:
            ...
            for feat in self.feature_names:
                if feat not in valid_features:
                    ...
                    feature_names.append(f'{feat}={feature_classes[feat][X.loc[feat]]}')
        else:
            for feat in self.feature_names:
                feature_names.append(f'{feat}={X.loc[feat]}')
    ...
    def plot_local_explain(self, X, feature_classes=None):
        ...
        plots.plot_local_feature_influence(feat_importance=values, based_value=based_value, pred=pred)
